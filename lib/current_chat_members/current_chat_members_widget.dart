...
import 'current_chat_members_model.dart';
export 'current_chat_members_model.dart';
...
class _CurrentChatMembersWidgetState extends State<CurrentChatMembersWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CurrentChatMembersModel());
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  '${widget.chatChosen?.users?.length?.toString()} People',
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelText:
                                      ...
                                      '8pcapbl6' /* Search by Name or Email... */,
                                    ),
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: List.generate(columnUsersRecordList.length,
                            ...
                            return Visibility(
                              visible: columnUsersRecord.messageChats
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              animation: true,
                                                                              animateFromLastPercent: true,
                                                                              progressColor: FlutterFlowTheme.of(context).prayerRing,
                                                                              backgroundColor: FlutterFlowTheme.of(context).tertiarySystemBackground,
                                                                            ),
                                                                          ),
                                                                          Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              animation: true,
                                                                              animateFromLastPercent: true,
                                                                              progressColor: FlutterFlowTheme.of(context).worshipRing,
                                                                              backgroundColor: FlutterFlowTheme.of(context).tertiarySystemBackground,
                                                                            ),
                                                                          ),
                                                                          Column(
