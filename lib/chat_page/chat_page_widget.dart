                                                                                          ...
                                                                                          child: InkWell(
                                                                                            ...
                                                                                            onTap: () async {
                                                                                              ...
                                                                                              await columnMessagesRecord.reference.update({
                                                                                                ...mapToFirestore(
                                                                                                  {
                                                                                                    'messageLikedBy': FieldValue.arrayUnion([currentUserReference]),
                                                                                                    'personReactingList': FieldValue.arrayRemove([currentUserReference]),
                                                                                                  },
                                                                                                ),
                                                                                              });
                                                                                          ...
                                                                                          onTap: () async {
                                                                                            ...
                                                                                            if (columnMessagesRecord.messageCriedBy.contains(currentUserReference) == true) {
                                                                                              await columnMessagesRecord.reference.update({
                                                                                                ...mapToFirestore(
                                                                                                  {
                                                                                                    'messageCriedBy': FieldValue.arrayRemove([currentUserReference]),
                                                                                                    'personReactingList': FieldValue.arrayRemove([currentUserReference]),
                                                                                                  },
                                                                                                ),
                                                                                              });
                                                                      ...
                                                                      return WebViewAware(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                PDFViewerWidget(
                                                                              pdfImageSelected: columnMessagesRecord,
                                                                              pdfImageSelectedRef: columnMessagesRecord.reference,
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ));
