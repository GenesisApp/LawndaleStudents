...
import 'recent_checkins_model.dart';
export 'recent_checkins_model.dart';

class RecentCheckinsWidget extends StatefulWidget {
  const RecentCheckinsWidget({super.key});

  @override
  State<RecentCheckinsWidget> createState() => _RecentCheckinsWidgetState();
}

class _RecentCheckinsWidgetState extends State<RecentCheckinsWidget> {
  late RecentCheckinsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecentCheckinsModel());
                              ...
                              child: Align(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'u6ihxsgy' /* Search by Name or Email... */,
                                    ),
                  ...
                  FutureBuilder<List<UsersRecord>>(
                    future: queryUsersRecordOnce(
                      queryBuilder: (usersRecord) => usersRecord
                          ...
                          .orderBy('lastAttendance', descending: true),
                    ),
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      '6hepspzw' /* Most Recent Attendance: */,
                                                                    ),
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'og7lco3m' /* Most Recent Attendance: */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
