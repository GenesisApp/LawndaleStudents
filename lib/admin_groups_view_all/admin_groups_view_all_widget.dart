...
import 'admin_groups_view_all_model.dart';
...
class _AdminGroupsViewAllWidgetState extends State<AdminGroupsViewAllWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminGroupsViewAllModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'jhnoxz37' /* Click any group below to view ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
