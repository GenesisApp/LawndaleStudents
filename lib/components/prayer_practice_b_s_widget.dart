...
import 'prayer_practice_b_s_model.dart';
export 'prayer_practice_b_s_model.dart';

class PrayerPracticeBSWidget extends StatefulWidget {
  const PrayerPracticeBSWidget({
    Key? key,
    this.dailyPractice,
  }) : super(key: key);
  ...
  @override
  _PrayerPracticeBSWidgetState createState() => _PrayerPracticeBSWidgetState();
}

class _PrayerPracticeBSWidgetState extends State<PrayerPracticeBSWidget>
    with TickerProviderStateMixin {
  late PrayerPracticeBSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrayerPracticeBSModel());
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                          'g3ccy7cl' /* Prayer Journal Prompt */,
                        ),
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'tw06y1y2' /* Write you response here */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
