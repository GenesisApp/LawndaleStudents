...
import 'edit_practice_response2_model.dart';
export 'edit_practice_response2_model.dart';

class EditPracticeResponse2Widget extends StatefulWidget {
  const EditPracticeResponse2Widget({
    Key? key,
    this.usersResponse,
  ...
  @override
  _EditPracticeResponse2WidgetState createState() =>
      _EditPracticeResponse2WidgetState();
}

class _EditPracticeResponse2WidgetState
    extends State<EditPracticeResponse2Widget> {
  late EditPracticeResponse2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPracticeResponse2Model());
