...
import 'featured_notification_groups_model.dart';
export 'featured_notification_groups_model.dart';
...
class _FeaturedNotificationGroupsWidgetState
    extends State<FeaturedNotificationGroupsWidget> {
  late FeaturedNotificationGroupsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeaturedNotificationGroupsModel());
  }
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'nlonw6q1' /* Do you want this to notify all... */,
                                ),
                                ...
                                onTap: () async {
                                  triggerPushNotification(
                                    ...
                                    userRefs: containerUsersRecordList
                                        .map((e) => e.reference)
                                        .toList(),
                                    initialPageName: 'GroupDetails',
                                    parameterData: {
                                      'chosenGroup': widget.chosenResource,
                                    },
                                  );
                                  HapticFeedback.lightImpact();
