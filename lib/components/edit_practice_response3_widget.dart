...
import 'edit_practice_response3_model.dart';
export 'edit_practice_response3_model.dart';

class EditPracticeResponse3Widget extends StatefulWidget {
  const EditPracticeResponse3Widget({
    Key? key,
    this.usersResponse,
  ...
  @override
  _EditPracticeResponse3WidgetState createState() =>
      _EditPracticeResponse3WidgetState();
}

class _EditPracticeResponse3WidgetState
    extends State<EditPracticeResponse3Widget> {
  late EditPracticeResponse3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPracticeResponse3Model());
