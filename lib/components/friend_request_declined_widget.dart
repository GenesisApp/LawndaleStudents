...
import 'friend_request_declined_model.dart';
export 'friend_request_declined_model.dart';
...
class _FriendRequestDeclinedWidgetState
    extends State<FriendRequestDeclinedWidget> {
  late FriendRequestDeclinedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriendRequestDeclinedModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'h4g6ner3' /* Friend request declined. */,
                            ),
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              await widget.friendRequest!
                                  .update(createFriendRequestsRecordData(
