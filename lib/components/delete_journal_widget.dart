...
import 'delete_journal_model.dart';
export 'delete_journal_model.dart';
...
class _DeleteJournalWidgetState extends State<DeleteJournalWidget> {
  late DeleteJournalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteJournalModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'peu24936' /* Are you sure you want to delet... */,
                            ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await widget.journalRef!.delete();
                              HapticFeedback.lightImpact();
