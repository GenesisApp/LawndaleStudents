...
import 'delete_chat_poll_model.dart';
export 'delete_chat_poll_model.dart';
...
class _DeleteChatPollWidgetState extends State<DeleteChatPollWidget> {
  late DeleteChatPollModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteChatPollModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'pvotvyte' /* Are you sure you want to delet... */,
                            ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await widget.currentPoll!.reference.delete();
                              HapticFeedback.lightImpact();
