...
import 'friend_requests_model.dart';
          ...
          Container(
            ...
            child: StreamBuilder<List<FriendRequestsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<FriendRequestsRecord> columnFriendRequestsRecordList =
                    snapshot.data!;
                if (columnFriendRequestsRecordList.isEmpty) {
                  return EmptystateFRWidget();
                }
                return Column(
                  mainAxisSize: MainAxisSize.max,
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: List.generate(columnFriendRequestsRecordList.length,
                      (columnIndex) {
                                              ...
                                              image: CachedNetworkImageProvider(
                                                valueOrDefault<String>(
                                                  containerUsersRecord
                                                      .backgroundPhotoURL,
                                                  'https://rare-gallery.com/mocahbig/43181-Sun-River-Windows-11-LandscapeWindows-11-4k-Ultra.jpg',
                                                ),
                                              ),
                                            ),
                                            borderRadius:
                                                ...
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    highlightColor:
                                                        Colors.transparent,
                                                    onTap: () async {
                                                      await columnFriendRequestsRecord
                                                          .requestSender!
                                                          .update({
                                                        ...mapToFirestore(
                                                          {
