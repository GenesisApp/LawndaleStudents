...
import 'worship_update_future_model.dart';
export 'worship_update_future_model.dart';
...
class _WorshipUpdateFutureWidgetState extends State<WorshipUpdateFutureWidget> {
  late WorshipUpdateFutureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorshipUpdateFutureModel());
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'wr3gvrji' /* Enter the updated information ... */,
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'uy4b17wg' /* Practice Response Question */,
                            ),
                            labelStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
