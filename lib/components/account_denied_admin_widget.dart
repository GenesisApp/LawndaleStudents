...
import 'account_denied_admin_model.dart';
...
class _AccountDeniedAdminWidgetState extends State<AccountDeniedAdminWidget> {
  late AccountDeniedAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountDeniedAdminModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '5zwkac9z' /* Your account has been denied b... */,
                            ),
