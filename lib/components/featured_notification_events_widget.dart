...
import 'featured_notification_events_model.dart';
export 'featured_notification_events_model.dart';
...
class _FeaturedNotificationEventsWidgetState
    extends State<FeaturedNotificationEventsWidget> {
  late FeaturedNotificationEventsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeaturedNotificationEventsModel());
  }
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'c1dix4p8' /* Do you want this to notify all... */,
                                ),
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  triggerPushNotification(
                                    ...
                                    notificationText:
                                        '${widget.chosenResource?.videoName} is now live!',
