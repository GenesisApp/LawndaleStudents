...
class ProfileTabIconWidget extends StatefulWidget {
  const ProfileTabIconWidget({super.key});

  @override
  State<ProfileTabIconWidget> createState() => _ProfileTabIconWidgetState();
}
      ...
      child: Column(
        ...
        children: [
          if (Theme.of(context).brightness == Brightness.dark)
            SvgPicture.asset(
              'assets/images/user-fill_(chosen_dark_mode).svg',
              width: 28.0,
              height: 28.0,
              fit: BoxFit.cover,
            ),
          if (!(Theme.of(context).brightness == Brightness.dark))
            SvgPicture.asset(
              'assets/images/user-fill_(chosen_light_mode).svg',
              width: 28.0,
              height: 28.0,
              fit: BoxFit.cover,
            ),
