...
import 'read_scripture_model.dart';
export 'read_scripture_model.dart';
...
class _ReadScriptureWidgetState extends State<ReadScriptureWidget> {
  late ReadScriptureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadScriptureModel());
    ...
    _model.textController1 ??= TextEditingController(
        text: widget.pdfImageSelected?.scriptureReference);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: widget.pdfImageSelected?.scripturePassage);
