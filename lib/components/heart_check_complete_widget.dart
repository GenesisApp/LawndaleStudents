...
import 'heart_check_complete_model.dart';
...
class _HeartCheckCompleteWidgetState extends State<HeartCheckCompleteWidget> {
  late HeartCheckCompleteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeartCheckCompleteModel());
  }
