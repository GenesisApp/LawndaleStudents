...
import 'delete_chat_poll_copy_model.dart';
export 'delete_chat_poll_copy_model.dart';
...
class _DeleteChatPollCopyWidgetState extends State<DeleteChatPollCopyWidget> {
  late DeleteChatPollCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteChatPollCopyModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'hj733zss' /* Are you sure you want to delet... */,
                            ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await widget.currentEvent!.reference.delete();
                              HapticFeedback.lightImpact();
