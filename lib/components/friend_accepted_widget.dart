...
import 'friend_accepted_model.dart';
export 'friend_accepted_model.dart';
...
class _FriendAcceptedWidgetState extends State<FriendAcceptedWidget> {
  late FriendAcceptedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriendAcceptedModel());
  }
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              await currentUserReference!.update({
                                ...mapToFirestore(
                                  {
                                    'userFriends': FieldValue.arrayUnion(
                                        [widget.selectedUser]),
                                  },
                                ),
                              });
