...
import 'scripture_practice_b_s_model.dart';
export 'scripture_practice_b_s_model.dart';
...
class _ScripturePracticeBSWidgetState extends State<ScripturePracticeBSWidget>
    with TickerProviderStateMixin {
  late ScripturePracticeBSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScripturePracticeBSModel());
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                          'cahi6pj4' /* Scripture Journal Prompt */,
                        ),
                                              ...
                                              if (_model.scanResults2!) {
                                                ...
                                                var personalJournalsRecordReference =
                                                    PersonalJournalsRecord
                                                        .collection
                                                        .doc();
                                                await personalJournalsRecordReference
                                                    .set(
                                                ...
                                                if (dateTimeFormat(
                                                  ...
                                                  var adminDataRecordReference =
                                                      AdminDataRecord.collection
                                                          .doc();
                                                  await adminDataRecordReference
                                                      .set(
                                ...
                                return Column(
                                  ...
                                  children: List.generate(
                                    ...
                                    return JournalResponsePreviewWidget(
                                      key: Key(
                                          'Keyida_${columnIndex}_of_${columnPersonalJournalsRecordList.length}'),
                                      journalInListRef:
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Column(
                                    ...
                                    children: List.generate(
                                      ...
                                      return JournalResponsePreviewWidget(
                                        key: Key(
                                            'Keyznb_${columnIndex}_of_${columnPersonalJournalsRecordList.length}'),
                                        journalInListRef:
                                            columnPersonalJournalsRecord
                                                .reference,
                                        journalInListDoc:
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'uuofbhja' /* Write your response here */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
