...
import 'edit_prayer_model.dart';
export 'edit_prayer_model.dart';
...
class _EditPrayerWidgetState extends State<EditPrayerWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPrayerModel());
              ...
              Padding(
                ...
                child: SwitchListTile(
                  ...
                  onChanged: (newValue) async {
                    ...
                    if (newValue!) {
                      await widget.usersPrayerDoc!.reference
                          .update(createPrayerRequestsRecordData(
                        public: true,
                      ));
                    } else {
                  ...
                  title: Text(
                    FFLocalizations.of(context).getText(
                      't58hua5o' /* Make this prayer public? */,
                    ),
