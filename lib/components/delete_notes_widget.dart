...
import 'delete_notes_model.dart';
export 'delete_notes_model.dart';
...
class _DeleteNotesWidgetState extends State<DeleteNotesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteNotesModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'e62o6vpy' /* Are you sure you want to delet... */,
                            ),
