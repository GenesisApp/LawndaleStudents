...
import 'welcome_to_church_model.dart';
...
class _WelcomeToChurchWidgetState extends State<WelcomeToChurchWidget> {
  late WelcomeToChurchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WelcomeToChurchModel());
  }
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'xy1ifsdm' /* Welcome to church! We hope you... */,
                            ),
                            ...
                            onTap: () async {
                              await currentUserReference!.update({
                                ...createUsersRecordData(
                                  dateNoticeSeen: functions.getDayDate(),
                                  lastAttendance: getCurrentTimestamp,
                                ),
                                ...mapToFirestore(
                                  {
                                    'datesAtChurch': FieldValue.arrayUnion(
