...
import 'percentage_completed3_model.dart';
...
class _PercentageCompleted3WidgetState
    extends State<PercentageCompleted3Widget> {
  late PercentageCompleted3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PercentageCompleted3Model());
  }
                              ...
                              Column(
                                ...
                                children: [
                                  if (valueOrDefault<bool>(
                                      currentUserDocument?.complete3, false))
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'afhmcwkt' /* Congratulations! You've comple... */,
                            ),
