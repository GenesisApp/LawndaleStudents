...
import 'delete_guest_model.dart';
export 'delete_guest_model.dart';
...
class _DeleteGuestWidgetState extends State<DeleteGuestWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteGuestModel());
  }
