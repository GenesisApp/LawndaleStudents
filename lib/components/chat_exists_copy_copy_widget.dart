...
import 'chat_exists_copy_copy_model.dart';
...
class _ChatExistsCopyCopyWidgetState extends State<ChatExistsCopyCopyWidget> {
  late ChatExistsCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatExistsCopyCopyModel());
  }
