...
import 'add_group_people_widget.dart' show AddGroupPeopleWidget;
...
class AddGroupPeopleModel extends FlutterFlowModel<AddGroupPeopleWidget> {
  ...
  GlobalGroupsDataRecord? newDate1;
  // Stores action output result for [Backend Call - Create Document] action in CheckboxListTile widget.
  GlobalGroupsDataRecord? newDate2;
  // State field(s) for CheckboxListTile widget.
  ...
  // Stores action output result for [Backend Call - Create Document] action in CheckboxListTile widget.
  GlobalGroupsDataRecord? newDate4;
  // Stores action output result for [Backend Call - Create Document] action in CheckboxListTile widget.
  GlobalGroupsDataRecord? newDate3;
