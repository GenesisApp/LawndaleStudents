...
import 'series_catalog_model.dart';
export 'series_catalog_model.dart';

class SeriesCatalogWidget extends StatefulWidget {
  const SeriesCatalogWidget({
    Key? key,
    required this.videoChosen,
    required this.videoChosenDoc,
  }) : super(key: key);

  final DocumentReference? videoChosen;
  final ResourceVideosRecord? videoChosenDoc;

  @override
  _SeriesCatalogWidgetState createState() => _SeriesCatalogWidgetState();
}

class _SeriesCatalogWidgetState extends State<SeriesCatalogWidget>
    with TickerProviderStateMixin {
  late SeriesCatalogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeriesCatalogModel());
                                            ...
                                            child: Align(
                                              ...
                                              child: TextFormField(
                                                ...
                                                onFieldSubmitted: (_) async {
                                                  await queryVideoSeriesRecordOnce()
                                                      .then(
                                                        (records) => _model
                                                                .simpleSearchResults =
                                                            TextSearch(
                            ...
                            children: [
                              if (FFAppState().showFullList)
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 50.0),
                                  child: StreamBuilder<List<VideoSeriesRecord>>(
                                    stream: queryVideoSeriesRecord(),
                                    builder: (context, snapshot) {
                                      ...
                                      List<VideoSeriesRecord>
                                          columnVideoSeriesRecordList =
                                          snapshot.data!;
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                if (!(Theme.of(context)
                                                    ...
                                                    Brightness.dark))
                                                  SvgPicture.asset(
                                                    'assets/images/hands-clapping-fill_(1).svg',
                                                    width: 28.0,
                                                    height: 28.0,
                                                    fit: BoxFit.cover,
                                                  ),
