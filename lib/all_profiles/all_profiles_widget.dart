                              ...
                              child: Align(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'an4x4yqz' /* Search by Name or Email... */,
                                    ),
                        ...
                        child: Column(
                          ...
                          children: List.generate(columnUsersRecordList.length,
                            ...
                            return ProfileQuickviewWidget(
                              key: Key(
                                  'Key2cg_${columnIndex}_of_${columnUsersRecordList.length}'),
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: List.generate(searchResults.length,
                            ...
                            return ProfileQuickviewWidget(
                              key: Key(
                                  'Keymi5_${searchResultsIndex}_of_${searchResults.length}'),
