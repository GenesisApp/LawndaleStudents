...
import 'my_heart_checks_model.dart';
...
class _MyHeartChecksWidgetState extends State<MyHeartChecksWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyHeartChecksModel());
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '5gb2p30o' /* Here's the overview of your He... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<List<HeartCheckRecord>>(
                          future: (_model.firestoreRequestCompleter ??=
                                  Completer<List<HeartCheckRecord>>()
                                    ..complete(queryHeartCheckRecordOnce(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<HeartCheckRecord> columnHeartCheckRecordList =
                                snapshot.data!;
