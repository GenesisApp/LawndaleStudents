...
import 'admin_groups_ratings_view_model.dart';
export 'admin_groups_ratings_view_model.dart';

class AdminGroupsRatingsViewWidget extends StatefulWidget {
  const AdminGroupsRatingsViewWidget({Key? key}) : super(key: key);

  @override
  _AdminGroupsRatingsViewWidgetState createState() =>
      _AdminGroupsRatingsViewWidgetState();
}

class _AdminGroupsRatingsViewWidgetState
    extends State<AdminGroupsRatingsViewWidget> with TickerProviderStateMixin {
  late AdminGroupsRatingsViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminGroupsRatingsViewModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '017r5nko' /* Click any group below to view ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                                                      ...
                                                                      Stack(
                                                                        ...
                                                                        children: [
                                                                          StreamBuilder<
                                                                              UsersRecord>(
                                                                            stream:
                                                                                UsersRecord.getDocument(gridViewGroupsRecord.groupLeaders.first),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                              if (!snapshot.hasData) {
